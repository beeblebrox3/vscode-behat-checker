...
describe("paths and config file", () => {
  ...
  test("should get correct cmd with custom behat path", () => {
    instance.updateConfig("/app2", "b.yml", "/global/behat");
    equals(instance.behatCMD, "php /global/behat");
  });
});
...
describe("extract context", () => {
  test("should extract the class and method", () => {
    equalsObject(instance.extractContext("   | at `Class::method()`"), {
      className: "Class",
      methodName: "method"
    });
  });
  ...
  test("should extract the class and method with namespace", () => {
    equalsObject(instance.extractContext("   | at `App\Class::method()`"), {
      className: "App\Class",
      methodName: "method"
    });
  });
  ...
  test("should extract the class and method with underline", () => {
    equalsObject(instance.extractContext("   | at `Class_xpto::method_foo()`"), {
  ...
  test("should extract class and method with accents", () => {
    equalsObject(instance.extractContext("   | at `Cláss::méthodã()`"), {
      className: "Cláss",
      methodName: "méthodã"
    });
  });
